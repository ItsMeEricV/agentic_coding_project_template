#!/usr/bin/env python3
"""
char_count.py — count RENDERED characters in LaTeX resume/CV bullets.
Strips LaTeX markup so you measure what a reader actually sees on the page,
then compares against the budget card in references/critique_framework.md.

Vendored from ARPeeketi/claude-resume-kit (MIT License, (c) 2026 Akhil Reddy Peeketi).
Used here unmodified for the resume-audit skill's LaTeX layout checks.
